...
def generate_random_number(total_random_number):
    return random.sample(range(0, 190), total_random_number)
...
def htr_fuel_height_replacer(height, read_file_name):
    ...
    print(f"Succesfully create input file for {height}")
...
def generator():
    ...
    read_file_name = input("Please input your basis file name = ")
    ...
    if answer == 'y':
      ...
      for height in random_heights:
          htr_fuel_height_replacer(height, read_file_name)
